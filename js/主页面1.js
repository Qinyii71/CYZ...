const carousel = document.querySelector('.carousel'); // 获取轮播容器元素
const images = carousel.querySelectorAll('img'); // 获取轮播容器内的所有图片元素
...
setInterval(nextImage, 5000); // 每隔4秒（4000毫秒）切换一次图片，实现自动轮播